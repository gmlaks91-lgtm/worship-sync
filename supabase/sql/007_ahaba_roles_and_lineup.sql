...
comment on column public.profiles.role_priority_1 is 'Ahaba 포지션 1순위';
comment on column public.profiles.role_priority_2 is 'Ahaba 포지션 2순위';
comment on column public.profiles.role_priority_3 is 'Ahaba 포지션 3순위';

-- 기존 데이터 백필 (leader/member만 있던 데이터 최소 기본값)
...
-- ---------------------------------------------------------------------------
-- 2) 가입 트리거: auth metadata에서 이름/역할 우선순위 반영
-- ---------------------------------------------------------------------------
...
comment on table public.setlist_lineups is '콘티별 포지션 라인업 배정 (Ahaba)';
